  ...
  return (
    <div>
      <div className="bg-[#F0DC28] h-[100px] flex items-center justify-between px-[100px] w-full ">
        ...
        <i class={`${nav?"hidden":"block sm:hidden"} fa-solid fa-bars text-5xl font-bold `} onClick={handleNav}></i>
        <i class={`${nav?"block sm:hidden":"hidden"} fa-solid fa-xmark text-5xl font-bold `} onClick={handleNav}></i>
      </div>
      <div>
